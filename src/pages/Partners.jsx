  ...
  return (
    <div className="venice-partners-page">
      ...
      <header className="partners-hero">
        ...
        <p className="hero-subtitle">Collaborating with visionaries to create impact</p>
      ...
      <div className="partners-content-wrapper">
        ...
        <section className="venice-section">
          ...
          <div className="luxury-logos-grid">
            <Link to="https://360moms.net/ar" target="_blank" className="logo-card">
              <img src="src/assets/partners/moms.png" alt={t("partners.moms_alt")} />
            </Link>
            <Link to="https://www.albiladpress.com/" target="_blank" className="logo-card">
        ...
        <section className="venice-section alt-bg">
          ...
          <div className="luxury-logos-grid">
            {[
              ...
              { link: "https://thinksmartgulf.com/", img: "thinksmart.png", alt: "thinksmart_alt" },
              { link: "https://www.instagram.com/alrawibooks/?hl=ar", img: "alrawi.png", alt: "alrawi_alt" },
              { link: "https://kipinakids.com/kipina-nursery-school-bahrain/", img: "kipina.png", alt: "kipina_alt" },
              { link: "https://www.fywedo.com/", img: "fywedo.png", alt: "fywedo_alt" },
              { link: "https://www.instagram.com/bahwu/?hl=ar", img: "bahwu.png", alt: "bahwu_alt" },
              { link: "https://gtrust.org/", img: "goldenTrust.png", alt: "goldenTrust_alt" },
            ].map((p, index) => (
              <Link key={index} to={p.link} target="_blank" className="logo-card">
                <img src={`src/assets/partners/${p.img}`} alt={t(`partners.${p.alt}`)} />
              </Link>
            ))}
          </div>
        </section>
        ...
        <section className="venice-section">
          ...
          <div className="luxury-logos-grid centered-grid">
            ...
            <Link to="https://benefit.bh/" target="_blank" className="logo-card">
        ...
        <footer className="partners-footer">
          <div className="footer-card">
            <p className="footer-statement">Building a creative future together</p>
