      ...
      <main className="venice-main">
        <section className="venice-info-section">
          <h2 className="venice-heading">
            Update Your <br /> Access Password
          </h2>
          <p className="venice-description">
            Your security is our priority. Please use the secure form to the
            right to update your authentication details. We recommend a password
